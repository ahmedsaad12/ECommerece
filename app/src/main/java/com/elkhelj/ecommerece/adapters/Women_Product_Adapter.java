...
public class Women_Product_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Women_Product_Adapter(List<Home_Model.Products> orderlist, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ProductswomenmenRowBinding binding = DataBindingUtil.inflate(inflater, R.layout.productswomenmen_row, parent, false);
...
eventHolder.itemView.setOnClickListener(new View.OnClickListener() {
    ...
    public class EventHolder extends RecyclerView.ViewHolder {
        public ProductswomenmenRowBinding binding;

        public EventHolder(@NonNull ProductswomenmenRowBinding binding) {
