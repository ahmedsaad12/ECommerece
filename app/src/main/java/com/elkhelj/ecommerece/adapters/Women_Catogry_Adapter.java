...
public class Women_Catogry_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            WomencatogryRowBinding binding = DataBindingUtil.inflate(inflater, R.layout.womencatogry_row, parent, false);
    ...
    public class EventHolder extends RecyclerView.ViewHolder {
        public WomencatogryRowBinding binding;

        public EventHolder(WomencatogryRowBinding binding) {
