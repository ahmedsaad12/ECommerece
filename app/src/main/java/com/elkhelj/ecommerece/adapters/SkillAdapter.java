...
public class SkillAdapter extends RecyclerView.Adapter<SkillAdapter.MyHolder> {
    ...
    private List<Size_Model> bankDataModelList;
    private Context context;
    private String current_language;
    private Fragment fragment;

    public SkillAdapter(List<Size_Model> bankDataModelList, Context context, Fragment fragment) {
...
this.fragment=fragment;
    ...
    public void onBindViewHolder(@NonNull final MyHolder holder, int position) {
        ...
        Size_Model bankModel = bankDataModelList.get(position);
...
image_delete=itemView.findViewById(R.id.image_delete);
        ...
        public void BindData(Size_Model bankModel) {
