...
fragment_detials.setdesc(body.getSingelproduct().getDes());
        ...
        if(body.getSingelproduct().getRates()!=null){
        fragment_review.setdesc(body.getSingelproduct().getRates(),body.getSingelproduct());}
        else {
            fragment_review.setdesc(body.getSingelproduct());}
